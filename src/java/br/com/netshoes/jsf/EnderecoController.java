package br.com.netshoes.jsf;

import br.com.netshoes.dominio.Endereco;
import br.com.netshoes.jsf.util.JsfUtil;
import br.com.netshoes.jsf.util.JsfUtil.PersistAction;
import br.com.netshoes.session.EnderecoFacade;
...
public class EnderecoController implements Serializable {
    ...
    @EJB
    private br.com.netshoes.session.EnderecoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("EnderecoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("EnderecoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("EnderecoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
